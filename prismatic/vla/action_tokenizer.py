...
class VQActionTokenizer(ActionTokenizer):
    ...
    def __init__(
        ...
        print("action_token_begin_idx: ", self.action_token_begin_idx)
        print("action_token_end_idx: ", self.action_token_end_idx)
    ...
    def __call__(self, action: np.ndarray, use_minivlm) -> Union[str, List[str]]:
        ...
        if use_minivlm:
            return (self.tokenizer_len - 1 - vq_code[0].numpy()).tolist()
        else:
