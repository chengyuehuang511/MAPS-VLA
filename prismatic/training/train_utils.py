...
def compute_actions_l1_loss(action_tokenizer, predicted_token_ids, ground_truth_token_ids, mask):
    ...
    # print('ground_truth_token_ids[mask] shape: ', ground_truth_token_ids[mask].shape)
    # print('predicted_token_ids[mask] shape: ', predicted_token_ids[mask].shape)
    # print('pred_continuous_actions shape: ', pred_continuous_actions.shape)
    # print('true_continuous_actions shape: ', true_continuous_actions.shape)
