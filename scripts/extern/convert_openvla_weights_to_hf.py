...
Usage:
    python -m vla-scripts.extern.convert_openvla_weights_to_hf \
        --openvla_model_path_or_id pretrained_models/prism-dinosiglip-224px+7b \
        --output_hf_model_local_path pretrained_models/prism-dinosiglip-224px+7b-hf
"""
